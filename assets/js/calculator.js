...
//variables
var NPr = 1, P = 1, S = 2, CD = 0, Sum = 0, PI = 1, MI = 1, Total = 0;
...
function Bill() {
  ...
  var pageNumber = $('.radio-btn__radio[name="number-page"]:checked').attr("data-value");
